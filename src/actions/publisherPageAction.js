...
export function getAllPackageForPublisher(publisherName) {
  return dispatch => PublisherPageApi.getAllPackages(publisherName).then((result) => {
...
export function getPublisherDetails(publisherName) {
  return dispatch => PublisherPageApi.getPublisherDetails(publisherName).then((result) => {
